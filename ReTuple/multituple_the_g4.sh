...
#printf '%s%s\n' "Adjust SNR index. SNR=0.5@i=2."; 
#./multituple 10005 1 2 3.0
#./multituple 10006 1 2 3.0
#./multituple 10007 1 2 3.0
#./multituple 10008 1 2 3.0
#./multituple 10065 1 2 3.0
#./multituple 10066 1 2 3.0
#./multituple 10001 1 2 3.0
#./multituple 10002 1 2 3.0
#./multituple 10013 1 2 3.0
#./multituple 10014 1 2 3.0
#./multituple 10009 1 2 3.0
#./multituple 10010 1 2 3.0
#./multituple 10011 1 2 3.0
#./multituple 10012 1 2 3.0
#printf '%s%s\n' "Done with multi-set 6!"; 


printf '%s%s\n' "Adjust the sigma agreement.  Up slightly.  "; 
./multituple 10005 1 0 3.5
./multituple 10006 1 0 3.5
./multituple 10007 1 0 3.5
./multituple 10008 1 0 3.5
./multituple 10065 1 0 3.5
./multituple 10066 1 0 3.5
./multituple 10001 1 0 3.5
./multituple 10002 1 0 3.5
./multituple 10013 1 0 3.5
./multituple 10014 1 0 3.5
./multituple 10009 1 0 3.5
./multituple 10010 1 0 3.5
./multituple 10011 1 0 3.5
./multituple 10012 1 0 3.5
printf '%s%s\n' "Done with multi-set 7!"; 

printf '%s%s\n' "Adjust the sigma agreement.  Now Down slightly.  "; 
./multituple 10005 1 0 2.5
./multituple 10006 1 0 2.5
./multituple 10007 1 0 2.5
./multituple 10008 1 0 2.5
./multituple 10065 1 0 2.5
./multituple 10066 1 0 2.5
./multituple 10001 1 0 2.5
./multituple 10002 1 0 2.5
./multituple 10013 1 0 2.5
./multituple 10014 1 0 2.5
./multituple 10009 1 0 2.5
./multituple 10010 1 0 2.5
./multituple 10011 1 0 2.5
./multituple 10012 1 0 2.5
printf '%s%s\n' "Done with multi-set 8!"; 
