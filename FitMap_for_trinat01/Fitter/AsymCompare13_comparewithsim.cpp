...
//	string datafilename = make_asymplot_datafilename("JustPlotA"+Escint_cal, "B", threshold_index, sigma_cut, bb1_maxr);

//	string datafilename = JustPlotA_path+"GenEnergyAsym_MirrorB_p.root";
	string datafilename = JustPlotA_path+"GenEnergyAsym_MirrorTB_p.root";
//	string datafilename = JustPlotA_path+"GenEnergyAsym_Default.root";
...
//	string datafilename_D = make_asymplot_datafilename("JustPlotA"+Escint_cal, "D", threshold_index, sigma_cut, bb1_maxr);
	...
	//
	TFile * data_file = new TFile( (datafilename).c_str() );
...
//	cout << "D:  " << datafilename_D << ", file=" << data_file_D << endl;
	...
	TH1D * h_Abeta_data_B = (TH1D*)data_file->Get( string("Set B Superratio Asymmetry -- Sim Best").c_str() );  // this has already been rebinned... 
...
//	h_Abeta_data_B -> SetName(h_Abeta_data_B->GetTitle());
	...
	*/
	...
	TH1D * h_Abeta_data_D = (TH1D*)data_file->Get( string("Set CD Superratio Asymmetry -- Sim Best").c_str() );
...
//	h_globalbest_C->SetTitle(h_globalbest_C->GetName());
	...
	h_globalbest_D->SetTitle(h_globalbest_D->GetName());
...
//	string chimin_string_C    = "min. chi2="+fake_to_string(minchi2_C)+" [NDF=42]";
	...
	string chimin_string_BCD    = "min.chi2="+fake_to_string(minchi2_BCD)+" [NDF=86]";
	//
...
// --- // --- // --- // --- // --- // --- // --- // --- // --- // --- // --- // --- //
	...
	these_results.orig_datafile_B = datafilename;
//	these_results.orig_datafile_C = datafilename_C;
	these_results.orig_datafile_D = datafilename;
